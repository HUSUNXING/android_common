...
public class ResizeTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //如果设置了比例
        switch (screenType) {
            case SimplePlayView.SCREEN_SCALE_ORIGINAL:
                width = mVideoWidth;
                height = mVideoHeight;
                break;
            case SimplePlayView.SCREEN_SCALE_16_9:
                ...
                break;
            case SimplePlayView.SCREEN_SCALE_4_3:
                if (height > width / 4 * 3) {
                    height = width / 4 * 3;
                } else {
                    width = height / 3 * 4;
                ...
                break;
            case SimplePlayView.SCREEN_SCALE_MATCH_PARENT:
                width = widthMeasureSpec;
                height = heightMeasureSpec;
                break;
            case SimplePlayView.SCREEN_SCALE_CENTER_CROP:
